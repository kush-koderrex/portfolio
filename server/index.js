import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component } from './chunks/index-93f54841-a6e0bf82.js';
...
<html lang="en">
    ...
    <!-- Twitter stuff -->
    <meta name="author" content="Kush Kumar" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:creator" content="@Kush_Kumar" />
    ...
    <!-- <script async defer data-domain="fantinel.dev" src="https://stats.fantinel.dev/js/index.js"><\/script>
...
class Server {
  ...
  async respond(request, options = {}) {
    ...
    if (!this.options.hooks) {
      const module = await import('./chunks/hooks-d259abab-e44d0e71.js');
      this.options.hooks = {
